...
AMMobile_product_vivo = Blueprint('AMMobile_product_vivo_api', __name__)
api = Api(AMMobile_product_vivo,  title='AM Mobile Product Vivo',description='AM Mobile Product Vivo API')
name_space = api.namespace('AMMobileProductVivo',description='AM Mobile Product Vivo')
			...
			try:		
				...
				if get_product_count > 0:
					...
					if get_product_meta_count > 0:
						...
						image = "https://d1lwvo1ffrod0a.cloudfront.net/36671/smasung_default.jpg"
