...
AMMobile_product_oppo = Blueprint('AMMobile_product_oppo', __name__)
api = Api(AMMobile_product_oppo,  title='AM Mobile Product Oppo',description='AM Mobile Product Oppo API')
name_space = api.namespace('AMMobileProductOppo',description='AM Mobile Product Oppo')
			...
			try:		
				...
				if get_product_count > 0:
					...
					if get_product_meta_count > 0:
						...
						image = "https://d1lwvo1ffrod0a.cloudfront.net/39631/oppo_default.jpeg"
